...
function Lightbox({ src, alt, onClose }: { src: string, alt: string, onClose: () => void }) {
  return (
    <div
      className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-90 transition-opacity duration-300 p-50 m-50"
      onClick={onClose}
...
export default function Home() {
  ...
  const content = {
    ...
    en: {
      ...
      education: [
        ...
        "IPA Japan Information Security Management (Scheduled Sep 2025)",
        "IPA Japan Fundamental Information Technology Engineer (Scheduled Jan 2026)",
      ],
  ...
  return (
    <>
      ...
      <div className={`max-w-2xl w-full mx-auto mb-8 p-6 rounded-xl border-2 shadow-lg transition-colors duration-300 text-sm sm:text-base leading-relaxed sm:leading-loose ${resolvedTheme === 'dark' ? 'bg-gray-900 border-yellow-400 text-yellow-100' : 'bg-yellow-50 border-yellow-400 text-yellow-900'}`}>
